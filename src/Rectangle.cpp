...
//   p0    P1
    ...
    Point p2(m_position.x() + m_scale.x(), m_position.y() + m_scale.y(), m_position.z());
    Point p3(m_position.x(), m_position.y() + m_scale.y(), m_position.z());
...
//    Triangle t12(p6, p2, p7, m_color);
    ...
    Triangle t1(p0, p1, p2, m_color);
    Triangle t2(p0, p2, p3, m_color);

    Triangle t3(p0, p1, p5, m_color);
    Triangle t4(p0, p4, p5, m_color);

    Triangle t5(p0, p3, p7, m_color);
    Triangle t6(p0, p4, p7, m_color);

    Triangle t7(p6, p1, p5, m_color);
    Triangle t8(p6, p1, p2, m_color);

    Triangle t9(p6, p3, p7, m_color);
    Triangle t10(p6, p3, p2, m_color);

    Triangle t11(p6, p4, p5, m_color);
    Triangle t12(p6, p4, p7, m_color);
